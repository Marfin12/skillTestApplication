...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/OpenSSL-Universal/Frameworks/OpenSSL.xcframework" "" "true" "ios-arm64_x86_64-maccatalyst/OpenSSL.framework" "ios-arm64_armv7/OpenSSL.framework" "ios-arm64_i386_x86_64-simulator/OpenSSL.framework"
fi
